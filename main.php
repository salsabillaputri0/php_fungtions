							...
							<div class="main-header-right">
								...
								<div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
									...
									<div class="dropdown main-profile-menu nav nav-item nav-link">
										...
										<a class="profile-user d-flex" href=""><img src="samiror.jpeg" alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>

										<div class="dropdown-menu">
											<div class="main-header-profile header-img">
												<div class="main-img-user"><img alt="" src="../assets/img/faces/6.jpg"></div>
												<h6>Salsabilla Putri Ranesti</h6>
											</div>
						...
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									<div class="user-pic">
										<img src="samiror.jpeg" alt="user-img" class="rounded-circle mCS_img_loaded">
									</div>
									<div class="user-info">
										<h6 class=" mb-0 text-dark">Salsabilla</h6>
										<span class="text-muted app-sidebar__user-name text-sm">Profile</span>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="main-content app-content">
			...
			<div class="main-container container-fluid">
				...
				<div class="breadcrumb-header justify-content-between">
					<div>
						<h4 class="content-title mb-2">My Profile!</h4>
								...
								<div class="ps-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="salsabu.jpeg"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
										<div class="d-flex justify-content-between mg-b-20">
											<div>
												<h5 class="main-profile-name">Salsabilla Putri Ranesti</h5>
												<p class="main-profile-name-text">Taruni</p>
											</div>
										</div>
										<h6>Bio</h6>
										<div class="main-profile-bio">
											<b>Everything will return to its original place....<br>
											the best feeling, is feeling nothing....</b><a href="">More</a>
										...
										<div class="main-profile-work-list">
											<div class="media">
												...
												<div class="media-body">
													<h6>WhatsApp <a href="">Salsabilla</a></h6>
													<p>No. 081212946069</p>
												</div>
											</div>
											<div class="media">
												...
												<div class="media-body">
													<h6>Studied at <a href="">Vocational School</a></h6><span>2021-2024</span>
													<p>Graduation: SMK NEGRI 2 SUBANG</p>
												</div>
											</div>
										...
										<div class="main-profile-social-list">
											<div class="media">
												...
												<div class="media-body">
													<span>Github</span> <a href="">github.com/salsabillaputri0</a>
												</div>
											</div>
											<div class="media">
												...
												<div class="media-body">
													<span>Instagram</span> <a href="">instagram.com/evolvesalsabilla</a>
												</div>
											</div>
											<div class="media">
											...
											<div class="card-body">
												<div class="card-header">
													<div class="media">
														...
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Hasil php Fungtions</h6>
														</div>
														<div class="ms-auto">
